  ...
  return (
    <div className="px-6 py-6">
      <header className="mb-6">
        ...
        <h1 className="text-2xl font-semibold tracking-tight text-slate-900">Nuevo propietario</h1>
        <p className="mt-1 text-sm text-slate-500">
          Alta inicial del propietario externo. El acceso al portal se crea en una fase aparte.
        </p>
      </header>
