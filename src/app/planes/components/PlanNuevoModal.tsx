...
import PlanNuevoForm from "./PlanNuevoForm";

export type PlanNuevoModalProps = {
  open: boolean;
  onClose: () => void;
  onCreated?: (id?: string) => void;
};

export default function PlanNuevoModal({ open, onClose, onCreated }: PlanNuevoModalProps) {
